                ...
                <div class="modal-body p-all-0" id="site-search">
                    ...
                    <div class="">
                        ...
                        <div class="list-group list  ">
                            ...
                            <div class="list-group-item d-flex  align-items-center">
                                <div class="m-r-20">
                                    <div class="avatar avatar-sm "><img class="avatar-img rounded-circle" src="{{ asset('assets/img/users/user-4.jpg') }}" alt="user-image"></div>
                                </div>
                                <div class="">
                            ...
                            <div class="list-group-item d-flex  align-items-center">
                                <div class="m-r-20">
                                    <div class="avatar avatar-sm "><img class="avatar-img rounded-circle" src="{{ asset('assets/img/users/user-8.jpg') }}" alt="user-image"></div>
                                </div>
                                <div class="">
